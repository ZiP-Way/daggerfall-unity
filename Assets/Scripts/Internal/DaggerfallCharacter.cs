...
{
    /// <summary>
    /// Stores character settings for serialization and other tasks.
    /// </summary>
    public abstract class DaggerfallCharacter : MonoBehaviour
    {
        ulong loadID = 0;
        ...
        private void Start()
        {
            ...
            // Assuming this means character sounds specficially, rather than *all sounds* (which could get annoying)
            // If player has acute hearing advantage then character audio source max distance is increased by 25%
            // If player also has improved acute hearing enchantment then character audio source max distance is increased by 50%
